...
[assembly: EdmRelationshipAttribute("NWindModel", "CategoryProduct", "Category", System.Data.Metadata.Edm.RelationshipMultiplicity.ZeroOrOne, typeof(E5153.Category), "Product", System.Data.Metadata.Edm.RelationshipMultiplicity.Many, typeof(E5153.Product), true)]
...
namespace E5153
{
    ...
    public partial class Category : EntityObject
    {
        ...
        public EntityCollection<Product> Products
        {
            get
            {
                return ((IEntityWithRelationships)this).RelationshipManager.GetRelatedCollection<Product>("NWindModel.CategoryProduct", "Product");
            }
            set
            {
                if ((value != null))
                {
                    ((IEntityWithRelationships)this).RelationshipManager.InitializeRelatedCollection<Product>("NWindModel.CategoryProduct", "Product", value);
                }
            }
        }
    ...
    public partial class Product : EntityObject
    {
        ...
        public Category Category
        {
            get
            {
                return ((IEntityWithRelationships)this).RelationshipManager.GetRelatedReference<Category>("NWindModel.CategoryProduct", "Category").Value;
            }
            set
            {
                ((IEntityWithRelationships)this).RelationshipManager.GetRelatedReference<Category>("NWindModel.CategoryProduct", "Category").Value = value;
            }
        }
        /// <summary>
        /// No Metadata Documentation available.
        ...
        public EntityReference<Category> CategoryReference
        {
            get
            {
                return ((IEntityWithRelationships)this).RelationshipManager.GetRelatedReference<Category>("NWindModel.CategoryProduct", "Category");
            }
            set
            {
                if ((value != null))
                {
                    ((IEntityWithRelationships)this).RelationshipManager.InitializeRelatedReference<Category>("NWindModel.CategoryProduct", "Category", value);
                }
            }
        }
